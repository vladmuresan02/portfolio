...
export default class Education extends Component {
    renderEducation() {
        return this.props.content.map(object => {
            return <div className="about-section" key={object.id}>
                <p className="about-section__period">{object.period}</p>
                <p className="about-section__institution">{object.institution}</p>
        ...
        return (
            <div className="row">
                ...
                <div className="col-lg-9 col-md-12 about__right-column">
                    <div className="about__content">{this.renderEducation()}</div>
                </div>
            </div>
        );
    }
